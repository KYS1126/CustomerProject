...
public class CustomerApplication {
	...
	public static void main(String[] args) {	
		...
		Customer find = findCustomer(10050);
		
		
		if (find == null) {
			System.out.println("존재하지 않은 회원입니다.");
		} else {
			showPriceBonus(find,10000);
		}
